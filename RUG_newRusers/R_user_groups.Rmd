...
<html>
  ...
  <hr color='#80FFE6' size=1px width=100%>
</html>
.pull-left[
...
- usually free & open to all (might require registration): students, professional, hobbyist, all levels of expeRtise.
...
(see also R Ladies [here](jumpingrivers.github.io/meetingsR/r-user-groups.html) or [here](https://rladies.org/))
