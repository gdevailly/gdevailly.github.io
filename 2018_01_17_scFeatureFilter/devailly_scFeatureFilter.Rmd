...
TPM above 1 in more than 25% of the considered cells.¹]
 
>.small[Genes with less than 5 reads and expressed in
less than 10 cells were removed.²] 
 
>.small[Here, low-abundance genes are defined as those 
with an average count below a filter threshold of 1 [count].³] 
...
- No domain standard for filtering.

- Same Read count, FPKM, or TPM threshold might not be of the *same stringency*
...
- Might help to set an relevant expression threshold for feature filtering.
...
|ENSG00000000460.15 |   7.08|   1.35|   5.42|  16.61|
|ENSG00000000938.11 |   0.00|   0.00|   0.00|   0.00|
]
...
.medium[48 repplicated bulk RNA-seq (yeast)] .tiny[(Gierliński et al., Bioinformatics, 2015)]
...
#
*vs* 1 or 2 parameters for arbitrary cut-off
...
- more abundant in the low expression bins (filtered) 

- less abundant in the high expression bins (ketp)
