...
**→ Allow user to do things they won't have done otherwise**
...
- apps appears and disapears often
...
- looking at a few regions manualy
...
- Compare a processed file you upload to all expriments in a dataset
...
- Corelation of every pairs of experiment
...
- *Blueprint* data anlaysis portal: [blueprint-data.bsc.es/release_2016-08](http://blueprint-data.bsc.es/release_2016-08/) 
